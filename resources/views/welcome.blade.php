    ...
    <section id="rooms">
      <div class="grid grid-cols-1 md:grid-cols-2">
        ...
        <div class="bg-grey-900 px-6 py-4 md:py-8 lg:px-20 lg:py-16">
          ...
          <h3 class="text-white -mt-5 text-base font-bold lg:text-3xl">
            Suite Clássica de um quarto
          </h3>
          <p class="mt-5 text-sm text-grey-400 lg:text-lg">
            Oferece uma experiência confortável e prática, ideal para quem busca
            descanso e conveniência em um ambiente acolhedor. Com uma decoração
            simples e funcional, o quarto é equipado com todas as comodidades
            essenciais para tornar a sua estadia relaxante.
          </p>
          <ul
          ...
          <button
            class="mt-2 rounded-lg bg-primary px-4 py-3 text-sm font-medium uppercase text-white-100 md:px-10 md:text-base lg:mt-5 lg:px-20 lg:text-lg"
          >
            Reservar
          </button>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2">
        ...
        <div class="bg-grey-100 px-6 py-4 md:py-8 lg:px-20 lg:py-16">
          ...
          <button
            class="mt-2 rounded-lg bg-primary px-4 py-3 text-sm font-medium uppercase text-white-100 md:px-10 lg:mt-5 lg:px-20 lg:text-lg"
          >
            Reservar
          </button>
        </div>
