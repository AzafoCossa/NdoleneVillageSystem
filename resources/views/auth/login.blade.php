...
<html lang="pt-BR">
    <head>
        ...
        <title>Ndolene Village | Login</title>
                        ...
                        <div class="">
                            <form method="POST" action="/login">
                                ...
                                <div class="mt-8 flex justify-between gap-5">
                                    <button
                                        type="submit"
                                        class="text-white w-full rounded-lg bg-primary py-3 hover:cursor-pointer"
                                    >
                                        Iniciar sessão
                                    </button>
                                    ...
                                    <a
                                        href="{{ route('register') }}"
                                        class="w-full rounded-lg bg-white-100 py-3 text-center text-grey-900"
                                    >
                                        Registar
                                    </a>
                                </div>
                            ...
                            <ul class="mt-2 flex flex-col gap-2 md:mt-5">
                                ...
                                <li class="flex items-center gap-2">
                                    ...
                                    >
                                        ...
                                        /></svg
                                    ><a href="#"
                                        >+258 879 670 611 / +258 825 169 373</a
                                    >
                                </li>
                            </ul>
                        </div>
